...
public class ArchersArmor extends ItemArmor{
	...
	public ArchersArmor(ArmorMaterial material, int armorIndex,
			int armorType) {
...
@Override
        ...
        {
                if (stack.getItem().equals(ArchersMod.rubyHelm) || stack.getItem().equals(ArchersMod.rubyChest) || stack.getItem().equals(ArchersMod.rubyBoots))
                {
        ...
        public void registerIcons(IIconRegister reg)
        {
                if (this == ArchersMod.rubyHelm)
                        this.itemIcon = reg.registerIcon(ArchersMod.modid + ":" + "archersHelmet");
                else if (this == ArchersMod.rubyChest)
                        this.itemIcon = reg.registerIcon(ArchersMod.modid + ":" + "archersChestplate");
                else if (this == ArchersMod.rubyLegs)
                        this.itemIcon = reg.registerIcon(ArchersMod.modid + ":" + "archers Leggings");
                else if (this == ArchersMod.rubyBoots)
                        this.itemIcon = reg.registerIcon(ArchersMod.modid + ":" + "archersBoots");
        }
}
